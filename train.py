...
def parse_arguments():
    ...
    parser.add_argument('--momentum', type=float, default=DEFAULT_MOMENTUM, help='Momentum (SGD)')
    ...
    parser.add_argument('--single_cls', action='store_true', help='Train as a single-class problem')
...
def train_yolo(args):
    ...
    print(f"🖥️ Device: {'CPU' if args.device == -1 else f'CUDA:{args.device}'}\n")
